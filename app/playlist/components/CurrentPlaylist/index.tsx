...
import PlaylistItemList from '@app/playlist/components/PlaylistItemList'

import usePartitionedPlaylist from './use/usePartitionedPlaylist'
...
const CurrentPlaylist = () => {
  ...
  const { prev, next } = usePartitionedPlaylist()
  ...
  return (
    <div className={styles.container}>
      ...
      <PlaylistInfo className={styles.info} />
    </div>
  )
}
